...
- Looking in /docs, there are 3 main categories: Academics, Opportunities, and Recreation. Let's take a look at /docs/Academics for reference. You can see an [`academics.md`](/docs/Academics/academics.md) file which serves as an overview (visible when clicking on a category). From here, there is [`course_rec.md`](/docs/Academics/CAS/course_rec.md) for CAS and [`course_rec.md`](/docs/Academics/Tandon/course_rec.md) for Tandon, [`schedule.md`](/docs/Academics/schedule.md), etc which talk about their respective subjects. However, if there's a topic that requires multiple articles, you can create a folder (ex. /Academics/Tandon) and create an overview file and more pages from here. 
